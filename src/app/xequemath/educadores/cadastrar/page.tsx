...
function CadastrarEducadorContent() {
  ...
  const onSubmit = async (data: ServiceInput) => {
    ...
    try {
      if (useMock) {
        alert("Educador cadastrado com sucesso! (mock)");
        router.push("/xequemath/educadores");
        return;
      }
      ...
      alert("Erro ao cadastrar educador. Tente novamente.");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-card border border-border rounded-2xl p-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Cadastrar Educador</h1>
          <p className="text-sm text-muted">Registre um educador de matematica para a comunidade</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1.5">Nome *</label>
            <input type="text" {...register("nome")} className={inputClass} placeholder="Nome do educador" />
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Descreva o perfil do educador..."
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder="Separadas por virgula: ENEM, Olimpiadas, Reforco"
            />
          ...
          <Button type="submit" size="lg" className="w-full" disabled={saving}>
            <Save size={18} /> {saving ? "Salvando..." : "Cadastrar Educador"}
          </Button>
        </form>
      </div>
    </div>
...
export default function CadastrarEducadorPage() {
  return (
    <ProtectedRoute>
      <CadastrarEducadorContent />
    </ProtectedRoute>
  );
}
